import 'package:bloc_full_learn/102/apis/login_api.dart';
import 'package:bloc_full_learn/102/apis/notes_api.dart';
import 'package:bloc_full_learn/102/bloc/actions.dart';
import 'package:bloc_full_learn/102/bloc/app_bloc.dart';
import 'package:bloc_full_learn/102/bloc/app_state.dart';
import 'package:bloc_full_learn/102/models.dart';
...
void main() {
  blocTest<AppBloc, AppState>(
    'Inintial state of the bloc should be AppState.empty()',
    build: () => AppBloc(
  ...
  blocTest<AppBloc, AppState>(
    'We shoudl not be able to log in with invalid credentials',
    build: () => AppBloc(
      loginApi: const DummyLoginApi(
